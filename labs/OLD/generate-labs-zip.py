...
# A chave é o caminho do arquivo dentro do zip
# Os arquivos lab.yaml seguem o modelo: https://github.com/badtuxx/girus-cli?tab=readme-ov-file#labyaml
files_content = {
...
Siga as instruções do post: https://blog.aeciopires.com/aprendendo-kubernetes-gateway-api-na-pratica-com-o-girus-cli/
""",
...
def create_zip_file():
    output_filename = "gateway-api-labs.zip"
    zip_buffer = io.BytesIO()
    
    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
        for file_path, content in files_content.items():
            # Normaliza o encoding
    ...
    print(f"Total de arquivos empacotados: {len(files_content)}")
